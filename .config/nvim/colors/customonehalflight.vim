...
"
"   Changed comment_fg, gutter_fg and non_text cterm values to a darker gray.
"   Changed the matching parenthesis to standout.
" ==============================================================================
...
let g:colors_name="customonehalflight"
let colors_name="customonehalflight"
...
let s:comment_fg  = { "gui": "#a0a1a7", "cterm": "240" }
let s:gutter_bg   = { "gui": "#fafafa", "cterm": "231" }
let s:gutter_fg   = { "gui": "#d4d4d4", "cterm": "240" }
let s:non_text    = { "gui": "#e5e5e5", "cterm": "240" }
...
call s:h("MatchParen", s:blue, "", "standout")
